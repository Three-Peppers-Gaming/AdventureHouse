...
namespace AdventureRealms.Services.AdventureClient.UI
{
    ...
    public interface IDisplayService
    {
        ...
        /// <summary>
        /// Display welcome message for the current game
        /// </summary>
        /// <param name="welcomeMessage">The welcome message text</param>
        /// <param name="gameName">The name of the game</param>
        /// <param name="useClassicMode">Whether to use classic console mode</param>
        void DisplayWelcomeMessage(string welcomeMessage, string gameName, bool useClassicMode);
