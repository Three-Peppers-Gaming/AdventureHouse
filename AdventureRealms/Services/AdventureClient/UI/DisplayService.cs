...
namespace AdventureRealms.Services.AdventureClient.UI
{
    ...
    public class DisplayService : IDisplayService
    {
        ...
        public void DisplayWelcomeMessage(string welcomeMessage, string gameName, bool useClassicMode)
        {
            _useClassicMode = useClassicMode;
            ...
            if (useClassicMode)
            {
                ...
                Console.WriteLine($"Welcome to {gameName}".PadLeft(30 + gameName.Length / 2));
                Console.WriteLine("=".PadRight(60, '='));
                Console.WriteLine();
            ...
            {
                var welcomePanel = new Panel(welcomeMessage)
                    .Header($"[bold green]Welcome to {gameName}[/]")
