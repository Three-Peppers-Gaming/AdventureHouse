...
namespace AdventureRealms.Services.AdventureServer.GameManagement
{
    public class MonsterManagementService : IMonsterManagementService
    {
        ...
        public string CheckForMonsters(PlayAdventureModel playAdventure)
        {
        ...
        public (PlayAdventureModel, CommandState) AttackMonster(PlayAdventureModel playAdventure, CommandState commandState)
        {
        ...
        private (PlayAdventureModel, CommandState) HandleWeaponAttack(
            PlayAdventureModel playAdventure, 
        ...
        private (PlayAdventureModel, CommandState) HandlePetAttack(
            PlayAdventureModel playAdventure, 
            CommandState commandState, 
            Monster targetMonster)
        {
        ...
        public string GetMonsterRoomDescription(PlayAdventureModel playAdventure)
        {
            var roomMonsters = playAdventure.Monsters.Where(m => 
                m.RoomNumber == playAdventure.Player.Room && 
                m.IsPresent && 
