...
namespace AdventureHouse.Tests.Integration
{
    /// <summary>
    ...
    public class MapGenerationIntegrationTests
    {
        ...
        private MapModel CreateMapModelFromPlayerMapData(PlayerMapData playerMapData)
        {
            ...
            var rooms = new List<AdventureHouse.Services.AdventureServer.Models.Room>();
            
            foreach (var discoveredRoom in playerMapData.DiscoveredRooms)
            {
                var room = new AdventureHouse.Services.AdventureServer.Models.Room
                {
            ...
            var gameConfig = new AdventureHouse.Services.Data.AdventureData.AdventureHouseConfiguration();
