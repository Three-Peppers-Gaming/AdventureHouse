    ...
    public class AdventureClientService : IAdventureClient
    {
        ...
        public void StartAdventure(IPlayAdventure adventureServer)
        {
            try
            {
                ...
                var newGameRequest = new AdventureHouse.Services.Shared.Models.GamePlayRequest 
                { 
                    SessionId = "", 
                ...
                do
                {
                    ...
                    var commandRequest = new AdventureHouse.Services.Shared.Models.GamePlayRequest
                    {
        ...
        /// </summary>
        private void DisplayGamePlayResponse(AdventureHouse.Services.Shared.Models.GamePlayResponse response)
        {
