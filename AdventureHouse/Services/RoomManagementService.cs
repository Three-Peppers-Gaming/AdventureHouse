...
namespace AdventureHouse.Services
{
    public class RoomManagementService : IRoomManagementService
    {
        ...
        public (bool PlayerMoved, GameMoveResult GameResult, PlayAdventure Adventure, CommandState CommandState) ProcessPlayerMovement(
        ...
        private (PlayAdventure, CommandState) MovePlayer(PlayAdventure playAdventure, CommandState commandState)
        {
